...
applicantMobile = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_60148224576'))

applicantMobile = mobile

applicantEmail = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_testernext6outlook.com'), 
    FailureHandling.STOP_ON_FAILURE)

applicantEmail = email

applicantAppliedDate = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_12292022'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/div_Avenew Realty'))
...
applicantMobile1 = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_60148224576'), 
    FailureHandling.STOP_ON_FAILURE)

applicantMobile1 = mobile1

applicantEmail1 = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_12292022'), 
    FailureHandling.STOP_ON_FAILURE)

applicantEmail1 = email1

applicantAppliedOn1 = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_12302022'), 
    FailureHandling.STOP_ON_FAILURE)
...
applicantProcessedOn1 = WebUI.getText(findTestObject('Object Repository/Agent Sign Up/Page_The Next Six Admin (SIT)/td_12302022'), 
    FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/Agent Sign Up/Page_Email - tester next6 - Outlook/input_Suggestions available. Press updown a_f67195'), 
    name1)
