...
test = WS.sendRequest(findTestObject('AdminURL', [('GlobalVariable.URL') : GlobalVariable.URL]))
def result2 = slurper.parseText(test.getResponseBodyContent())
def value1 = result2.campaignURL
